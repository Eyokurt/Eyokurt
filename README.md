...
- **Aura:** Kendi kendine çalışan bir AI asistan framework'ü üzerine çalışıyorum.
- **MakerConnect:** Ar-Ge ve inovasyon odaklı bir sosyal ağ geliştiriyorum.
- **PCB AI:** Prompt ile devre kartı tasarımı yapan bir GNN modeli eğitiyorum.
